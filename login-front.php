...
<form class="form-horizontal" method="POST" action="login-backend.php">
	<h1>User Login</h1>
...
<a href="admin-login.php"><button type="submit" name="" class="btn btn-success">Log in as Admin</button></a>
</div>
</center>
</div>
